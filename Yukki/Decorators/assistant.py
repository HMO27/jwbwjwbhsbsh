            ...
            if message.chat.username:
                try:
                    ...
                    await message.reply_text(
                        f"__فشل انضمام المساعد  يرجى الاتصال بل دعم لحل المشكله  بوت الدعم : uu6bot_\n\n**او تابع شروحات البوت :@cccNcN**: "
                    )
                    return
            else:
                try:
                    ...
                    await message.reply_text(
                        f"__فشل انضمام المساعد  يرجى الاتصال بل دعم لحل المشكله  بوت الدعم : uu6bot\n\n**او تابع شروحات البوت :@cccNcN**:"
                    )
                    return
